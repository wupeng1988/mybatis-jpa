...
import org.apache.ibatis.singledog.jpa.mapper.JpaMapper;
    ...
    void parseStatement(Method method) {
        ...
        if (sqlSource != null) {
            ...
            if (resultMapAnnotation != null) {
                ...
                if (JpaMapper.class.isAssignableFrom(type)) {//if mapper instance of JpaMapper
                    resultMapId = MetaDataParser.DEFAULT_RESULT_MAP;//using default result map
                } else {
